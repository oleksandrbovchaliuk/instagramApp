...
public class PostActivity extends AppCompatActivity {
    ...
    private void uploadImage(){
        ...
        if (imageUri != null) {
            ...
            uploadTask.continueWithTask(new Continuation() {
            ...
            }).addOnCompleteListener(PostActivity.this ,new OnCompleteListener<Uri>() {
                @Override
                public void onComplete(@NonNull Task <Uri>task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(PostActivity.this, "Помилка!", Toast.LENGTH_SHORT).show();
                    }
                }
            ...
            Toast.makeText(this, "Не вибрано фото!", Toast.LENGTH_SHORT).show();
        }
    }
